...
class FaceRecogniser(object):
    ...
    def camera_callback(self,data):
        ...
        print("DELTA CALLBACK=="+str(delta))
    ...
    def recognise(self,data):
        ...
        try:
            ...
            print(e)
        image_capture_time = rospy.get_time()
        rospy.logdebug("Image Capture Time ="+str(image_capture_time-start_time))
        ...
        load_samples_time = rospy.get_time()
        rospy.logdebug("Load Sample Time ="+str(load_samples_time- image_capture_time))
        ...
        resize_time = rospy.get_time()
        rospy.logdebug("Resize Time ="+str(resize_time- load_samples_time))
        ...
        processfaces_time = rospy.get_time()
        rospy.logdebug("processfaces_time ="+str(processfaces_time-resize_time))
        ...
        rescale_time = rospy.get_time()
        rospy.logdebug("rescale_time ="+str(rescale_time-processfaces_time))
